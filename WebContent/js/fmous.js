...
var words = ["Math is one of the foundations of computer sciences","It is also one of the more crucial elements in computer sciences.","Many of the functions and operators in all programming languages requires some knowledge in mathematics.","For example, these operator include arithmetic, comparison, logical, assignment and conditional operators.","All of the aforesaid tasks need mathematics for them to be used and properly applied, specially the arithmetic and conditional operators.","C is a programming language developed  At & T's Bell Laboratories of USA in 1972.","It was designed and written by a man named Dennis Ritchie.","Anything that computes is a computer.","Get busy living or get busy dying","Great minds discuss ideas"," Average minds discuss events", "Small minds discuss people","Planning for happiness is rarely successful","Whatever the mind of man can conceive and believe, it can achieve","Strive not to be a success, but rather to be of value","You miss 100% of the shots you don’t take","Every strike brings me closer to the next home run","Life is what happens to you while you’re busy making other plans","We become what we think about","An unexamined life is not worth living","The Way Get Started Is To Quit Talking And Begin Doing","The Way Get Started Is To Quit Talking And Begin Doing"
];
words = shuffle(words);
...
function endWordRace() {
    ...
    document.location.href ="fmous.jsp?start="+cnt; 
